<template>
	<el-dialog title="编辑应聘者" v-loading="loading" element-loading-text="加载中" :visible.sync="visible" width="70%" @close="closeDialog">
				...
				<el-row>
					<el-col :span="8">
						<el-form-item label="姓名" prop="name">
							<el-input :disabled="true" v-model="interview.name" placeholder="请输入姓名" class="form-item"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="性别" prop="sex">
							<el-radio :disabled="true" v-model="interview.sex" label="男" class="form-radio">男</el-radio>
							<el-radio :disabled="true" v-model="interview.sex" label="女">女</el-radio>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="电话" prop="phone">
							<el-input :disabled="true" v-model="interview.phone" placeholder="请输入电话" style="width: 218px;"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="8">
						<el-form-item label="部门" prop="department">
							<el-select :disabled="true" v-model="interview.department" class="form-item" placeholder="请选择部门">
					...
					<el-col :span="8">
						<el-form-item label="岗位" prop="station">
							<el-input :disabled="true" v-model="interview.station" placeholder="请输入岗位" class="form-item"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="招聘渠道" prop="channel">
							<el-select :disabled="true" v-model="interview.channel" style="width: 190px;" placeholder="请选择招聘渠道">
				...
				<el-row>
					<el-col :span="8">
						<el-form-item label="学校" prop="school">
							<el-input :disabled="true" v-model="interview.school" placeholder="请输入学校" class="form-item"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="毕业时间" prop="graduateTime">
							<el-date-picker :disabled="true" type="date" placeholder="请选择日期" v-model="interview.graduateTime" style="width: 192px;"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="8" style="padding-left: 10px;">
						<el-form-item label="现所在公司" prop="presentCompany">
							<el-input :disabled="true" v-model="interview.presentCompany" style="width: 178px;"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
		...
		methods: {
			...
			getDetail() {
				...
				api.interview.getInterDetail(id, this.cancelToken).then(res => {
					...
					this.interview.graduateTime = new Date($global.changeUTCTime(interview.graduateTime));
					...
					this.interview.end = interview.end;
			...
			submitForm(formName) {
				this.$refs[formName].validate(valid => {
					if(valid) {
						...
						let id = this.id;
						let data = {
							telephoneInterview: this.interview.telephoneInterview,
							recommended: this.interview.recommended,
							onSiteInterview: this.interview.onSiteInterview,
							interviewEvaluate: this.interview.interviewEvaluate,
							receiveOffer: this.interview.receiveOffer,
							reportTime: this.interview.reportTime,
							end: this.interview.end,
							remark: this.interview.remark
						};
						this.loading = true;
						api.interview.updateInterview(id, data, this.CancelToken)
							.then(res => {
								this.loading = false;
								this.visible = false;
								this.$emit('edit-succeed');
								this.$message({
									type: 'success',
									message: '修改成功'
								})
